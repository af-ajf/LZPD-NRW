...
const paths = {
  ...
  // Leichte Sprache: two scripts side by side, the sign a reader already knows
  // for "this content in another language". A speech bubble read as chat, and
  // the assistive-access symbol would have promised screen-reader settings.
  plainlanguage:
    '<path d="m5 8 6 6M4 14l6-6 2-3M2 5h12M7 2h1"/><path d="m22 22-5-10-5 10M14 18h6"/>',
